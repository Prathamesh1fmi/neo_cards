...
# Create dummy src-tauri module files
for f in ['src-tauri/src/commands.rs', 'src-tauri/src/domain.rs', 'src-tauri/src/infrastructure.rs']:
    (base / f).write_text('''// Module placeholder''')
